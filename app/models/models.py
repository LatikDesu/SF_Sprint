...
pereval_add_table = sqlalchemy.Table(
    ...
    sqlalchemy.Column("add_time", sqlalchemy.DateTime(), default=sqlalchemy.func.now(), nullable=False),
...
images_table = sqlalchemy.Table(
    ...
    sqlalchemy.Column("data_added", sqlalchemy.DateTime, default=sqlalchemy.func.now(), nullable=False),
)
